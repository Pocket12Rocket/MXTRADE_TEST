...
import { escapeHtml } from './server/request';

// Why: re-exported so existing/future call sites of `import { escapeHtml } from './emails'`
// keep working — the implementation itself now lives in lib/server/request.js (ARCH-06, was
// duplicated independently here and in two API routes).
export { escapeHtml };
  ...
  const html = `
    <div style="font-family:sans-serif;max-width:620px;margin:0 auto;color:#1e293b">
      ...
      <p style="margin-top:24px;font-size:13px;color:#475569">
        Please prepare your item for shipping. Fast Sports support will contact you with collection or delivery arrangements.
      </p>
